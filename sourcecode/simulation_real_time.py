'''the UI of real time simulation'''
...
class SimulationRealTime:
    def __init__(self):
        self.ui = uic.loadUi("./ui/simulation_real_time.ui")
        self.round = [0]
    ...
    def updateData(self):
        ...
        self.t = Thread1(sv2db.time_w,self.ui.traffic,direction)
        self.t.start()
        self.ui.show_car_ew.setText("车流量："+str(carwe))
        self.ui.show_time_ew.setText("绿灯时间："+str(sv2db.time_w))
        self.ui.show_car_sn.setText("车流量："+str(carns))
        self.ui.show_time_sn.setText("绿灯时间："+str(sv2db.time_n))
        self.round.append(self.round[-1] + 1)
        self.cars_sn.append(carns)
        self.green_time_sn.append(sv2db.time_n)
        ...
        self.green_time_ew.append(sv2db.time_w)
        self.ui.east_west.plot().setData(self.round, self.cars_ew, pen=pg.mkPen(color=(0, 128, 0), width=3))
        self.ui.east_west.plot().setData(self.round, self.green_time_ew, pen=pg.mkPen(color=(255, 215, 0), width=3))
